...
#sudo docker exec -it -w /public d435i bash
sudo docker exec -it d435i bash -c "source ~/catkin_ws/devel/setup.bash;roslaunch realsense2_camera rs_bagrecord.launch"
